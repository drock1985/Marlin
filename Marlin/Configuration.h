...
#define STRING_CONFIG_H_AUTHOR "(Derrick Rockwell, SK-Go² PINDA2 Volcano)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Gold Leader"
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  #else
    #define DEFAULT_Kp  17.98 //for volcano hotend @ 225c 10 count
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 96.89
  #define DEFAULT_bedKi 13.73
  #define DEFAULT_bedKd 455.82
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 200, 200, 400, 412 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -2.3, -67.6, 0 }

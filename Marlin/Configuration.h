...
#define STRING_CONFIG_H_AUTHOR "(Derrick Rockwell, Creality CR-10 SKR 1.3 EZABL)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Green Leader"
 ...
 */
#define NOZZLE_TO_PROBE_OFFSET { -41.5, 0, 0 }
